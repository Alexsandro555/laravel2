<template>
  <div class="AlexVueCarousel">
    <div class="AlexVueCarousel-wrapper">
      <div
              class="AlexVueCarousel-inner"
              v-bind:style="`
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      getCarouselWidth() {
        this.carouselWidth = (this.$el && this.$el.clientHeight) || 0 // Assign globally
